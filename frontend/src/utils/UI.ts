class UIClass {
  ...
  toast(message: string, type: 'info' | 'success' | 'warning' | 'error' = 'info', duration = 3000) {
    this.init();
  ...
  _createModal(title: string, content: string, buttons: Array<{ text: string; primary?: boolean; onClick: () => void }>) {
    this.init();
